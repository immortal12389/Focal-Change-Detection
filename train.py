...
if __name__ == "__main__":
    ...
    # parser.add_argument("--backbone", type=str, default="cswin_t_w40")
    parser.add_argument("--backbone", type=str, default="focalnet_96")
    ...
    #                    default="./runs/train/11/best_ckp/tf_efficientnetv2_s_in21k_w40_fpn+aspp+fuse+drop_fcn_epoch_81_0.91389.pt")  # 预训练权重路径
    #parser.add_argument("--pretrain", type=str,
    #                      default="./runs/train/1/best_ckp/focalnet_96_fpn+aspp+fuse+drop_fcn_epoch_346_0.92164.pt")  # 预训练权重路径
    parser.add_argument("--pretrain", type=str,
                        default="")  # 预训练权重路径
    parser.add_argument("--cuda", type=str, default="0")
    parser.add_argument("--dataset-dir", type=str, default="/mnt/Disk1/liyemei/change_detection/Mei_CDNet/CDData/WHU-CD/")
